...
The first improvement to the network is to add more hidden layers.
This allows the network to learn more complex patterns in the data, as the network can learn more complex functions.
